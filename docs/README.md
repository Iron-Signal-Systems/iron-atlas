...
A phase is not complete until the root README, documentation indexes, architecture status, requirements, test documentation, validation tooling, acceptance record, terminology, version statements, and next-work statement describe the same repository state.
